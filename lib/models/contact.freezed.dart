...
class _$_Contact implements _Contact {
  const _$_Contact({required this.id, required this.name, this.description});
  ...
  @override
  String toString() {
    return 'Contact(id: $id, name: $name, description: $description)';
  }
...
abstract class _Contact implements Contact {
  const factory _Contact(
      ...
      final String? description}) = _$_Contact;
